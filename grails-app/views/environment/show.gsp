...
<html>
    ...
    <body>
        ...
        <div class="body">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:environmentInstance, field:'password')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:environmentInstance, field:'hostName')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:environmentInstance, field:'username')}</td>
            ...
            <div class="buttons">
                <g:form>
                    <input type="hidden" name="id" value="${environmentInstance?.id}" />
